...
QT_MOC_LITERAL(1, 6, 12), // "successLogin"
...
QT_MOC_LITERAL(6, 75, 6), // "reshow"
QT_MOC_LITERAL(7, 82, 13) // "receiveLogout"

    },
    "login\0successLogin\0\0username\0"
    "on_pushButton_2_clicked\0on_pushButton_clicked\0"
    "reshow\0receiveLogout"
};
...
void login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&login::successLogin)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void login::successLogin(QString _t1)
{
